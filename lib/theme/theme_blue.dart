...
class MaterialThemeBlue {
  ...
  static const customColor1 = ExtendedColor(
    seed: Color(4278210004),
    value: Color(4278210004),
    light: ColorFamily(
      color: Color(4283128978),
      onColor: Color(4294967295),
      colorContainer: Color(4292600319),
      onColorContainer: Color(4278261579),
    ),
    ...
    dark: ColorFamily(
      color: Color(4290102527),
      onColor: Color(4279971169),
      colorContainer: Color(4281549945),
      onColorContainer: Color(4292600319),
    ),
