...
class MaterialTheme {
  ...
  static const customColor1 = ExtendedColor(
    seed: Color(4282511188),
    value: Color(4282511188),
    light: ColorFamily(
      color: Color(4282148921),
      onColor: Color(4294967295),
      colorContainer: Color(4290638003),
      onColorContainer: Color(4278198787),
    ),
    ...
    dark: ColorFamily(
      color: Color(4288795545),
      onColor: Color(4278925583),
      colorContainer: Color(4280569891),
      onColorContainer: Color(4290638003),
    ),
