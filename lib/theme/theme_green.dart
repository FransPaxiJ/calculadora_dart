...
class MaterialThemeGreen {
  ...
  static const customColor1 = ExtendedColor(
    seed: Color(4278546944),
    value: Color(4278546944),
    light: ColorFamily(
      color: Color(4282411062),
      onColor: Color(4294967295),
      colorContainer: Color(4290899887),
      onColorContainer: Color(4278264320),
    ),
    ...
    dark: ColorFamily(
      color: Color(4289057685),
      onColor: Color(4279318539),
      colorContainer: Color(4280897568),
      onColorContainer: Color(4290899887),
    ),
